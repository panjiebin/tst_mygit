...
<span><font style="font-size: large">竞赛项目管理</font></span>
<table border="1" class="tab_css_1" width="80%" style="margin-top: 10px;">
 <tr>
   <th>项目名称</th>
   <th>项目介绍</th>
   <th>个人or团体</th>
 ...
 <tr class="tr_css" align="center">
   ...
   <td><s:property value="%{#item.iort == 'individual' ? '个人' : '团体'}"/></td>
   <td><s:a href = "itemPreQuery.action?itemid=%{#item.iid}">点击查看</s:a></td>
	<td>
