        ...
        <TR>
          ...
          <TD align=middle>
            <TABLE cellSpacing=0 cellPadding=0 width=300 border=0>
              <FORM name=form1 action="admin_login.action" method=post>
              <TR>
                <TD colspan="3">
              ...
              <TR height=26>
                ...
                <TD width="75%"><INPUT 
                  ...
                  maxLength=30 size=20 name="admin.name"></TD></TR>
              <TR height=26>
                <TD>&nbsp; </TD>
                <TD>口　令：</TD>
                <TD><INPUT 
                  style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid" 
                  type=password maxLength=30 size=20  name="admin.password"></TD></TR>
               <TR height=26>
	                <TD>&nbsp; </TD>
	                <TD>验证码：</TD>
	                <TD><INPUT 
